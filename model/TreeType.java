...
public class TreeType extends EntityBase implements IView {
    ...
    public TreeType(String barcodePrefix) throws InvalidPrimaryKeyException {
        ...
        if (allDataRetrieved != null) {
            ...
            if (size != 1) {
                throw new InvalidPrimaryKeyException("Multiple tree types matching barcode prefix : " + barcodePrefix + " found.");
            } else {
            ...
            throw new InvalidPrimaryKeyException("No tree type matching tree type prefix : " + barcodePrefix + " found.");
        }
    }
    public void populateWithId(String treeTypeId) throws InvalidPrimaryKeyException {
        setDependencies();
        ...
        if (allDataRetrieved != null) {
            ...
            // There should be EXACTLY one TreeType. More than that is an error
            if (size != 1) {
                throw new InvalidPrimaryKeyException("Multiple tree types matching id : " + treeTypeId + " found.");
            } else {
                // copy all the retrieved data into persistent state
                Properties retrievedTreeTypeData = allDataRetrieved.elementAt(0);
                persistentState = new Properties();
