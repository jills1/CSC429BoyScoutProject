...
public class JDBCBroker
{
	...
	private static database.JDBCBroker myInstance = null;
	...
	//----------------------------------------------------------
	static public database.JDBCBroker getInstance()
	{
		// DEBUG: System.out.println("JDBCBroker.getInstance()");

		if(myInstance == null)
		{
			myInstance = new database.JDBCBroker();
		}
	...
	protected JDBCBroker()
	{
		...
		if (props != null)
		{
			...
			// DEBUG System.out.println(dbInstallationNameVal);
