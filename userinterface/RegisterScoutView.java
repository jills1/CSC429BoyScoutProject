...
public class RegisterScoutView extends View {
    ...
    public RegisterScoutView(IModel trans) {
        super(trans, "RegisterScoutView");
    ...
    private VBox createFormContent() {
        ...
        middleName.setOnAction(new EventHandler<ActionEvent>() {@Override public void handle(ActionEvent e) {processAction(e);}});
        ...
        phoneNumber.setOnAction(new EventHandler<ActionEvent>() {@Override public void handle(ActionEvent e) {processAction(e);}});
        grid.add(phoneNumber, 1, 4);
        //--------------------------------------------------------------------
        Label emailLabel = new Label("Email : ");
        grid.add(emailLabel, 0, 5);
        email = new TextField();
        email.setOnAction(new EventHandler<ActionEvent>() {@Override public void handle(ActionEvent e) {processAction(e);}});
        grid.add(email, 1, 5);
        //---------------------------------------------------------------------
        Label troopIDLabel = new Label("Troop ID : ");
        grid.add(troopIDLabel, 0, 6);
        troopID = new TextField();
        troopID.setOnAction(new EventHandler<ActionEvent>() {@Override public void handle(ActionEvent e) {processAction(e);}});
        ...
        cancelButton.setOnAction(new EventHandler<ActionEvent>() {@Override public void handle(ActionEvent e) {clearErrorMessage();myModel.stateChangeRequest("CancelRegisterScout", null);}});
        //------------------------------------------------------------------
    ...
    private void processAction(Event evt) {
        ...
        } else processScoutInfo(lastNameEntered,firstNameEntered,middleNameEntered,dateOfBirthEntered,phoneNumberEntered,emailEntered,troopIDEntered,statusEntered);
    }
